...
export function Sidebar({ currentUser }: { currentUser: User }) {
  ...
  return (
    <>
      <aside
        className={cn(
          "flex flex-col w-full sm:w-80 border-r shrink-0 transition-colors duration-300 bg-card",
          "max-sm:absolute max-sm:inset-y-0 max-sm:left-0 max-sm:z-10 max-sm:bg-background max-sm:backdrop-blur-sm",
